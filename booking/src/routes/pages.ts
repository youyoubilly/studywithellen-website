  ...
  pages.get("/", (c) => {
    ...
    const body = `
      <main class="card">
        ...
        <form method="post" action="/book/api/requests" class="form" id="booking-form">
          ...
          <div class="purpose-field">
            ...
            <input type="radio" name="purpose" value="trial" checked hidden tabindex="-1" />
            <input type="radio" name="purpose" value="recruitment" hidden tabindex="-1" />
          ...
          <div class="slot-section js-only" id="slot-picker">
            ...
            <div class="hidden-inputs" id="slot-hidden-inputs"></div>
          </div>
          <noscript>
          ...
          <button type="submit" class="btn-primary">${escapeHtml(text.submit)}</button>
        </form>
      </main>`;
